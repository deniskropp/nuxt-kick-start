import{u as x,_ as b}from"./kick.83895441.js";import{d as w,r as _,b as s,c as i,M as e,f as l,g as $,Y as C,Z as S,$ as V,e as p,X as B}from"./entry.049bffab.js";import"./ContentRendererMarkdown.vue.ac42dad1.js";import"./index.1bc6aa09.js";import"./path-meta.4b43dac3.js";import"./defu.528efe6d.js";import"./node.f7b4ab96.js";import"./asyncData.78ed7bfc.js";import"./info.bc4f8456.js";const M={style:{display:"flex","flex-direction":"column"}},N={key:0,style:{width:"40px",height:"2px","background-color":"rebeccapurple","margin-top":"1em"}},R=["disabled"],T=p("div",null,"🏴‍☠️",-1),D=[T],E=["disabled"],K={key:0,xstyle:"scale: 0.9; margin: -10% -5% -5% -5%; border-top: 1px solid;"},U=p("div",null,"✨",-1),X={key:1},J=w({__name:"TestChat",props:{task:{type:String,default:"continue the chat"}},setup(g){const v=g,o=_(""),a=_(""),{markdown:r,pending:t,ask:Y,messages:u,generate:f}=x(v);async function c(d){t.value=!0,a.value&&d&&u.push({role:"assistant",content:a.value}),u.push({role:"user",content:o.value}),a.value=await f(u),d?r.value+=`
