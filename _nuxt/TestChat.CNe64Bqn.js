import{_ as w,u as $}from"./kick.vsJ5oeJJ.js";import{d as C,r as v,Y as S,b as s,c as a,J as e,f as l,g as V,$ as B,a0 as N,a1 as M,e as c,Z as R}from"./entry.DQjF-wqm.js";import"./ContentRendererMarkdown.vue.DmKoYOQB.js";import"./MDCRenderer.CR_Rwcqi.js";import"./_commonjsHelpers.BosuxZz1.js";import"./node.BneCoJRQ.js";import"./path-meta.CYFnLAi5.js";import"./asyncData.HD1m4usc.js";import"./info.CBgmeYPm.js";const T={style:{display:"flex","flex-direction":"column"}},A={key:0,style:{width:"40px",height:"2px","background-color":"rebeccapurple","margin-top":"1em"}},D=["disabled"],E=c("div",null,"🏴‍☠️",-1),J=[E],K=["disabled"],U={key:0,xstyle:"scale: 0.9; margin: -10% -5% -5% -5%; border-top: 1px solid;"},Y=c("div",null,"✨",-1),Z={key:1},Q=C({__name:"TestChat",props:{task:{type:String,default:"continue the chat"}},async setup(f){let r,_;const h=f,o=v(""),i=v(""),{markdown:d,pending:t,ask:j,messages:m,generate:k}=([r,_]=S(()=>$(h)),r=await r,_(),r);async function g(u){t.value=!0,i.value&&u&&m.push({role:"assistant",content:i.value}),m.push({role:"user",content:o.value}),i.value=await k(m),u?d.value+=`
