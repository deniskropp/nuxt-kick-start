import{s as a,M as o}from"./entry.97df4b94.js";import{u as s}from"./asyncData.9572d43e.js";function u(t){var n=[];return t.type==="text"&&n.push(t.value??"ERROR"),t.tag==="li"&&n.push("- "),t.children&&t.children.forEach(r=>n.push(u(r))),n.join(`
`).replaceAll(`- 
