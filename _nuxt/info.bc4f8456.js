import{q as a,M as o}from"./entry.049bffab.js";import{u as s}from"./asyncData.78ed7bfc.js";function u(t){var n=[];return t.type==="text"&&n.push(t.value??"ERROR"),t.tag==="li"&&n.push("- "),t.children&&t.children.forEach(r=>n.push(u(r))),n.join(`
`).replaceAll(`- 
