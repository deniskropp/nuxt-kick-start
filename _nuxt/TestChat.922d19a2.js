import{_ as C,u as S}from"./useKick.9bfdec57.js";import{d as T,r as k,X as V,b as a,c as i,M as e,f as u,g as B,Z as M,$ as N,a0 as q,e as g,Y as R,q as A}from"./entry.41ccf12b.js";import"./ContentRendererMarkdown.vue.f654110a.js";import"./path-meta.5fff6f39.js";import"./node.f7b4ab96.js";import"./asyncData.a0f3a2f4.js";const D={style:{display:"flex","flex-direction":"column"}},E={key:0,style:{width:"40px",height:"2px","background-color":"rebeccapurple","margin-top":"1em"}},K=["disabled"],U=g("div",null,"🏴‍☠️",-1),X=[U],Y=["disabled"],Z={key:0,xstyle:"scale: 0.9; margin: -10% -5% -5% -5%; border-top: 1px solid;"},j=g("div",null,"✨",-1),z={key:1},P=T({__name:"TestChat",props:{task:{type:String,default:"continue the chat"}},async setup(w){let c,h;const x=w,s=k(""),l=k(""),{markdown:p,pending:t,ask:F,messages:m,generate:b}=([c,h]=V(()=>S(x)),c=await c,h(),c);async function v(_){const o=await A({type:"page"}),f=(r=>{console.log(r);let d="";for(const n of r)n.type==="heading"?n.depth===1?d+=`# ${n.title}
`:n.depth===2?d+=`## ${n.title}
`:d+=`### ${n.title}
`:d+=`${n._path}
