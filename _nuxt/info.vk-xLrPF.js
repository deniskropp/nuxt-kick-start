import{s as r,J as u}from"./entry.BleeUNnb.js";import{u as a}from"./asyncData.CJr9eoCn.js";function s(t){const n=[];return t.type==="text"&&n.push(t.value??"ERROR"),t.tag==="li"&&n.push("- "),t.children&&t.children.forEach(o=>n.push(s(o))),n.join(`
`).replaceAll(`- 
