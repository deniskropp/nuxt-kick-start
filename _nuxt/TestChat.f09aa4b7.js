import{_ as C,u as S}from"./useKick.205acf86.js";import{d as T,r as k,X as V,b as a,c as i,M as e,f as u,g as B,Z as M,$ as N,a0 as q,e as g,Y as R,q as A}from"./entry.d2b734c4.js";import"./ContentRendererMarkdown.vue.3c3f55df.js";import"./path-meta.9207cd89.js";import"./node.f7b4ab96.js";import"./asyncData.0f695992.js";const D={style:{display:"flex","flex-direction":"column"}},E={key:0,style:{width:"40px",height:"2px","background-color":"rebeccapurple","margin-top":"1em"}},K=["disabled"],U=g("div",null,"🏴‍☠️",-1),X=[U],Y=["disabled"],Z={key:0,style:{scale:"0.9",margin:"-10% -5% -5% -5%","border-top":"1px solid"}},j=g("div",null,"✨",-1),z={key:1},P=T({__name:"TestChat",props:{task:{type:String,default:"continue the chat"}},async setup(w){let c,h;const x=w,s=k(""),l=k(""),{markdown:p,pending:t,ask:F,messages:m,generate:b}=([c,h]=V(()=>S(x)),c=await c,h(),c);async function v(_){const o=await A({type:"page"}),f=(r=>{console.log(r);let d="";for(const n of r)n.type==="heading"?n.depth===1?d+=`# ${n.title}
`:n.depth===2?d+=`## ${n.title}
`:d+=`### ${n.title}
`:d+=`${n._path}
