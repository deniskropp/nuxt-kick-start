import{_ as $,u as C}from"./useKick.d08ef155.js";import{d as S,r as k,X as T,b as a,c as i,M as e,f as u,g as V,Z as q,$ as B,a0 as M,e as g,Y as N,q as R}from"./entry.75e7d0d7.js";import"./ContentRendererMarkdown.vue.1556e860.js";import"./path-meta.673362fb.js";import"./defu.528efe6d.js";import"./node.f7b4ab96.js";import"./asyncData.803eff5f.js";const A={style:{display:"flex","flex-direction":"column"}},D={key:0,style:{width:"40px",height:"2px","background-color":"rebeccapurple","margin-top":"1em"}},E=["disabled"],K=g("div",null,"🏴‍☠️",-1),P=[K],U=["disabled"],X={key:0,xstyle:"scale: 0.9; margin: -10% -5% -5% -5%; border-top: 1px solid;"},Y=g("div",null,"✨",-1),Z={key:1},O=S({__name:"TestChat",props:{task:{type:String,default:"continue the chat"}},async setup(w){let m,h;const b=w,s=k(""),r=k(""),{markdown:c,pending:t,ask:j,messages:p,generate:x}=([m,h]=T(()=>C(b)),m=await m,h(),m);async function y(_){const o=await R({type:"page"});(l=>{console.log(l);let d="";for(const n of l)n.type==="heading"?n.depth===1?d+=`# ${n.title}
`:n.depth===2?d+=`## ${n.title}
`:d+=`### ${n.title}
`:d+=`${n._path}
