import{_ as h,u as w}from"./useKick.a01420ac.js";import{d as x,r as m,X as b,b as n,c as o,M as e,f as s,g as C,Z as S,$ as V,a0 as $,e as B,Y as M,F as N}from"./entry.3d21d425.js";import"./ContentRendererMarkdown.vue.dd8b638e.js";import"./path-meta.a849c287.js";import"./node.f7b4ab96.js";import"./asyncData.b7c3d4f3.js";const F={key:0,style:{width:"40px",height:"2px","background-color":"rebeccapurple","margin-top":"1em"}},R=["disabled"],T={key:0},A={key:1},D={key:2,style:{scale:"0.7",margin:"-20% -10% -10% -10%","border-top":"1px solid"}},q=x({__name:"TestChat",props:{task:{type:String,default:"continue the chat"}},async setup(_){let r,c;const g=_,a=m(""),l=m(""),{markdown:u,pending:t,ask:E,messages:d,generate:k}=([r,c]=b(()=>w(g)),r=await r,c(),r);async function f(){async function p(){d.push({role:"user",content:a.value}),l.value=await k(d),u.value+=`
