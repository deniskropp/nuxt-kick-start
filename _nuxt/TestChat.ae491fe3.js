import{_ as y,u as w}from"./useKick.64243a25.js";import{d as x,r as m,X as b,b as n,c as a,M as e,f as s,g as C,Z as S,$ as V,a0 as $,e as B,Y as M,F as N}from"./entry.6325f0de.js";import"./ContentRendererMarkdown.vue.cf05a9a3.js";import"./path-meta.412a316b.js";import"./node.f7b4ab96.js";import"./asyncData.4b5cde49.js";const F={key:0,style:{width:"40px",height:"2px","background-color":"rebeccapurple","margin-top":"1em"}},R=["disabled"],T={key:0},A={key:1},D={key:2,style:{scale:"0.7",margin:"-20% -10% -10% -10%","border-top":"1px solid"}},q=x({__name:"TestChat",props:{name:{task:String,default:"continue the chat"}},async setup(_){let r,p;const g=_,o=m(""),l=m(""),{markdown:u,pending:t,ask:E,messages:d,generate:k}=([r,p]=b(()=>w(g)),r=await r,p(),r);async function f(){async function c(){d.push({role:"user",content:o.value}),l.value=await k(d),u.value+=`
