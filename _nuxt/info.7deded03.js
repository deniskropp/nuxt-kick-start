import{q as a,M as o}from"./entry.d6e3be80.js";import{u as s}from"./asyncData.999ee357.js";function u(t){var n=[];return t.type==="text"&&n.push(t.value??"ERROR"),t.tag==="li"&&n.push("- "),t.children&&t.children.forEach(r=>n.push(u(r))),n.join(`
`).replaceAll(`- 
